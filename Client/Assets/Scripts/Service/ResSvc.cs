...
public class ResSvc: MonoBehaviour {
    ...
    #endregion
    #region enhancementCfg
    private Dictionary<int, Dictionary<int, StrongCfg>> strongDic = new Dictionary<int, Dictionary<int, StrongCfg>>(); //<pos,<star,strongCfg>>
    ...
    // obain the Strengh Attribute Bonus of this pos+star
    ...
    //obtain the enhancement Strengh Attribute Bonus
